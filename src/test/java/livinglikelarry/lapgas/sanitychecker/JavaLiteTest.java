...
/**
 * 
 * sanity checker class to make sure you can go further with this project make
 * sure you make it green before you go along with us :)
 * 
...
public class JavaLiteTest {
	...
	public static void init() throws IOException {
		 ...
		 * ex : jdbc.url = jdbc:mysql://localhost/ jdbc.username = larry
